...
import com.endless.video.http.model.RequestHandler;
import com.endless.video.http.model.RequestServer;
import com.endless.video.manager.ActivityManager;
import com.endless.video.other.AppConfig;
import com.endless.video.other.CrashHandler;
import com.endless.video.other.DebugLoggerTree;
import com.endless.video.other.MaterialHeader;
import com.endless.video.other.SmartBallPulseFooter;
import com.endless.video.other.TitleBarStyle;
import com.endless.video.other.ToastLogInterceptor;
import com.endless.video.other.ToastStyle;
...
//                    headers.put("versionCode", String.valueOf(AppConfig.getVersionCode()));
        ...
        GsonUtils.setGsonDelegate(GsonFactory.getSingletonGson());
        // 初始化日志打印
